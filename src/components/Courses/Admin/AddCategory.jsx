...
export default function AddCategory() {
  ...
  const validateInput = (name, value) => {
    ...
    if (!regex.test(value)) {
      setErrors((prev) => ({
        ...prev,
        [name]:
          "Only letters, spaces, and allowed special characters are permitted",
      }));
      return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.message || "Category Adding failed";
      ...
      <div className="flex-grow">
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900 hidden lg:block">
              Add New Category
            </h1>
            <button
              onClick={toggleSidebar}
