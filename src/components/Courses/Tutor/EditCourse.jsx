...
export default function EditCourse() {
    ...
    try {
      ...
      if (result.isConfirmed) {
        await axiosInstance.delete(`/tutor/course/viewcourse/`, {
          params: { tutorId: tuorDatas._id, courseId: id },
        });
  ...
  const handleRemoveLesson = async (lessonId) => {
    try {
      ...
      if (result.isConfirmed) {
        await axiosInstance.delete(`/tutor/course/editlesson/`, {
          params: { tutorId: tuorDatas._id, lessonId },
        });
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="space-y-2">
                    {courseData.courseStructure?.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 border-dashed border-gray-300 bg-rose-50"
                      >
                        {editingStructureIndex === index ? (
                          <>
                            <input
                              ...
                              value={item}
                              onChange={(e) =>
                                handleStructureChange(index, e.target.value)
                              }
                            ...
                            <div>
                              ...
                              <button
                                onClick={() => setEditingStructureIndex(null)}
                          ...
                          <>
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                onClick={() => handleEditStructure(index)}
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {courseData.lessons?.map((lesson) => (
                      <div
                        key={lesson._id}
                        className="border rounded-lg p-4 border-dashed border-gray-300 bg-rose-50"
                      >
                        <video
                          controls
                        ...
                        >
                          <source
                            src={lesson.Video || "/placeholder.mp4"}
                            type="video/mp4"
                          />
